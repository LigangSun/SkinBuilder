    ...
    class TabPageSwitcherDesigner : ParentControlDesigner {
        ...
        public override System.ComponentModel.Design.DesignerVerbCollection Verbs {
            get {
                if (verbs == null) {
                    ...
                    verbs.Add(new DesignerVerb(ZLIS.SkinBuilder.Properties.Resource.AddTab, new EventHandler(this.OnAdd)));         
                }
        ...
        private void OnAdd(object sender, EventArgs eevent) {
            ...
            if (host != null) {
                ...
                try {
                    try {
                        t = host.CreateTransaction(ZLIS.SkinBuilder.Properties.Resource.AddTab + Component.Site.Name);
                    }
