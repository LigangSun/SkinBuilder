...
namespace ZLIS.SkinBuilder
{
    public abstract class AbstractRenderer
    {
        ...
        public virtual Color BaseRectColor 
        {
            get
            {
                return Color.FromArgb(141, 147, 217);
            }
        }

        public virtual Color HeaderCenterColor 
        {
            get 
            {
                return Color.FromArgb(205, 219, 238);
            }
        }

        public virtual Color HeaderStartColor 
        {
            get 
            {
                return Color.FromArgb(228, 236, 246);
            }
        }

        public virtual Color HeaderMiddleColor1 
        {
            get
            {
                return Color.FromArgb(214, 226, 241);
            }
        }

        public virtual Color HeaderMiddleColor2
        {
            get
            {
                return Color.FromArgb(194, 212, 235);
            }
        }

        public virtual Color HeaderEndColor 
        {
            get 
            {
                return Color.FromArgb(208, 222, 239);
            }
        }
        ...
        public abstract void DrawDayHeader(Graphics g, Rectangle rect, DateTime date, DateTime today);
        ...
        public virtual void DrawDayGripper(Graphics g, Rectangle rect, int gripWidth, bool today)
        {
