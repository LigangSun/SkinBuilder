...
namespace ZLIS.SkinBuilder
{
    public class Office12Renderer : AbstractRenderer
    {
        ...
        public override Color HeaderCenterColor
        {
            get
            {
                return base.HeaderCenterColor;
            }
        }
        ...
        public override void DrawDayHeader(System.Drawing.Graphics g, System.Drawing.Rectangle rect, DateTime date, DateTime today)
        {
            ...
            using (LinearGradientBrush aGB = new LinearGradientBrush(topPart, this.HeaderStartColor, this.HeaderMiddleColor1, LinearGradientMode.Vertical))
                g.FillRectangle(aGB, topPart);

            using (LinearGradientBrush aGB = new LinearGradientBrush(lowPart, this.HeaderMiddleColor2, this.HeaderEndColor, LinearGradientMode.Vertical))
